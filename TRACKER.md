...
- **2026-08-28** — Hovered rows now draw a subtle background so it is clear which row the ⋯ / ↗ / ✕ buttons belong to; selection keeps its own highlight, and the fade is skipped under Reduce Motion (E2-189).
